...
const VerticalCutReveal = forwardRef<VerticalCutRevealRef, TextProps>(
  (
    ...
    const splitIntoCharacters = (textValue: string): string[] => {
      if (typeof Intl !== "undefined" && "Segmenter" in Intl) {
        const segmenter = new (Intl as any).Segmenter("en", { granularity: "grapheme" })
        return Array.from(segmenter.segment(textValue), ({ segment }: any) => segment)
      }
      return Array.from(textValue)
    }

    // Split according to splitBy
    ...
    return (
      ...
      >
        ...
        {(splitBy === "characters"
          ...
          const previousCharsCount = (array as WordObject[])
            .slice(0, wordIndex)
              ...
              {wordObj.characters.map((char, charIndex) => (
                ...
                >
                  <motion.span
                    ...
                    variants={variants}
                    onAnimationComplete={
                      wordIndex === (elements as any).length - 1 &&
